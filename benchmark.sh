...
run_variant() {
    ...
    local base_java_cmd_no_coh="java -XX:NativeMemoryTracking=summary $ADDITIONAL_JAVA_OPTS -XX:-UseCompactObjectHeaders"
    local base_java_cmd_coh="java -XX:NativeMemoryTracking=summary $ADDITIONAL_JAVA_OPTS -XX:+UseCompactObjectHeaders"
